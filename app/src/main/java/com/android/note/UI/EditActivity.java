...
public class EditActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        List<TypeBean> typeBeans = new TypeDao(this).queryTypesAll();
        for (int i = 0; i < typeBeans.size(); i++) {
            strings.add(typeBeans.get(i).getTitle());
        }
        String[] array = new String[strings.size()];

        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item, strings.toArray(array));
    ...
    private void saveNoteDate() {
        ...
        note.setCreateTime(myCreate_time);
